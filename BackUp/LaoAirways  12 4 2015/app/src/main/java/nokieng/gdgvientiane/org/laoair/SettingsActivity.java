...
//    private ArrayList<HashMap<String, String>> mListRate;
    ...
    protected void onResume() {
        super.onResume();
        bindPreferenceSummaryToValue(findPreference(getString(R.string.KEY_CURRENCY)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.KEY_KEEP_HISTORY)));
    }
...
/*
    ...
    @Override
    public void onCreateNavigateUpTaskStack(@NonNull android.app.TaskStackBuilder builder) {
